...
const EditProfileModal = ({ visible, onClose }: EditProfileModalProps) => {
  ...
  return (
    ...
    >
      <div>
        <Typography.Text strong><Trans>Email</Trans></Typography.Text><br/>
        <Typography.Text>
          {me.email}
        </Typography.Text>
      </div>
      <div>
        <Typography.Text strong><Trans>First name</Trans></Typography.Text>
        <Input
          value={firstName}
      ...
      <div>
        <Typography.Text strong><Trans>Last name</Trans></Typography.Text>
        <Input
          value={lastName}
