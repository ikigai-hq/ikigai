...
Installation means running all components of our `ikigai` [architecture](/architecture).
We highly recommend reviewing the base architecture documentation before proceeding with the installation.
...
You can join our [community](/community). We're here to help!
