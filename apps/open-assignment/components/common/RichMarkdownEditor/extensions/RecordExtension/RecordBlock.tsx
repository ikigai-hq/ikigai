    ...
    switch (type) {
      case MediaPermissionsErrorType.PermissionDenied:
        ...
        setModal({
          ...
          message: `Open Assignment needs your permission to access your ${devices} so others can hear you.
          Please go to your browser's settings to grant Open Assignment access.
