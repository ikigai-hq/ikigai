...
export default function DocumentPage({ data }: IProps) {
  ...
  return (
    <>
      <Head>
        <title>{data?.title || "Open Assignment"}</title>
        <meta property="og:title" content={data?.title || "Open Assignment"} />
        <meta property="og:image" content={data?.coverPhotoUrl} />
        <meta property="og:description" content={data?.title} />

        <meta name="twitter:title" content={data?.title || "Open Assignment"} />
