...
pub fn get_score(quiz: &QuizStructure, answer: &QuizAnswer) -> Result<f64, IkigaiError> {
...
impl QuizStructureStats {
    pub fn get(
        conn: &PgConnection,
        quiz_structure_id: Uuid,
    ) -> Result<Option<QuizStructureStats>, IkigaiError> {
    ...
    ) -> Result<QuizStructureStats, IkigaiError> {
