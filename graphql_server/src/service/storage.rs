...
impl Storage {
    ...
    pub fn generate_upload_info(
        ...
        content_length: i64,
        public: bool,
    ) -> Result<UploadInfo, OpenExamError> {
    ...
    pub async fn get_file_info(&self, key: String) -> Result<Option<FileInfo>, OpenExamError> {
        let client = self.get_client().await;
    ...
    pub async fn delete_file(&self, key: &str) -> Result<(), OpenExamError> {
        let client = self.get_client().await;
        client
            .delete_object()
            .bucket(self.s3_bucket.as_str())
    ...
    pub async fn create_multiple_part(
        ...
        key: &str,
        content_type: &str,
    ) -> Result<CreateMultipartUploadOutput, OpenExamError> {
        let client = self.get_client().await;
    ...
    pub async fn upload_part(
        ...
        data: ByteStream,
    ) -> Result<CompletedPart, OpenExamError> {
        let client = self.get_client().await;
    ...
    ) -> Result<CompleteMultipartUploadOutput, OpenExamError> {
